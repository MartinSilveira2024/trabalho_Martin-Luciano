...
<body>
    ...
    <a href="form_update.php?id_usuario='<?php echo $usuario['id_usuario']; ?>'"> Alterar perfil </a> <br> <br>
    <a href="delete.php?id_usuario='<?php echo $usuario['id_usuario']; ?>'"> Excluir perfil </a> <br> <br>
